...
/////////////////////////////////////////////////////////
    ...
    public Task getTask(int id) {
        if (!tasks.containsKey(id)) throw new IllegalArgumentException("Tasks with such ID do not exist");
        Task t = tasks.get(id);
...
/////////////////////////////////////////////////////////
    ...
    public Epic getEpic(int id) {
        if (!epics.containsKey(id)) throw new IllegalArgumentException("Epic with such ID does not exist");
...
/////////////////////////////////////////////////////////
    public void addSubTask(SubTask subTask) {
        ...
        } else throw new IllegalArgumentException("It is not possible to create a subtask without an epic");
    }
    ...
    public SubTask getSubTask(int id) {
        ...
        } else throw new IllegalArgumentException("Subtasks with such ID do not exist");
        return subtasks.get(id);
    }

    public void deleteSubTask(int id) {
        if (!subtasks.containsKey(id)) throw new IllegalArgumentException("Subtasks with such ID do not exist");
                ...
                for (Task taskTree : prioritizedTasks) {
                    if (!(taskTree.getType() == TaskType.EPIC && taskTree.getStartTime() == null)) {
                        if ((!taskTree.equals(task)) &&
                            ...
                            throw new InsertTaskExeption("Tasks cannot be executed simultaneously\n" + "Task " + taskTree.getName() + " overlaps with " + task.getName());
                        }
                    }
